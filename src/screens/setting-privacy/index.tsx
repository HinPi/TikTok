  ...
  return (
    <ScrollView style={{ backgroundColor: '#f5f5f5', flex: 1 }}>
      <View style={{ marginTop: 30 }}>
        <TextField
          label={'Accout'}
          style={{ color: '#85868c', fontSize: 14, fontWeight: '700', marginLeft: 25, marginBottom: 10 }}
        />
        <TouchableOpacity onPress={() => setStatus(true)}>
          ...
          >
            ...
            <TextField label={'Log out'} style={{ color: 'black', fontSize: 16, fontWeight: '700', marginLeft: 15 }} />
